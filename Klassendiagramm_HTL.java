...
// Folgender Abteil: Um Funktionalitaet aufzuzeigen/////////////////////////////////////////////////////////////////////////////
		...
		a1.setAbteilungsvorstand(b,a1);	// ET erhï¿½lt neuen AV
		HTL.setDirektor(a);
		if(HTL.setDirektor(b) == false) //System.out.print("Keine 2 Vorstï¿½nde mï¿½glich!");
		HTL.setDirektor(e);
		a1.setAbteilungsvorstand(a,a1);	// Aufgabe des Direktors wird ï¿½bertragen, a kann neue Aufgabe ï¿½bernehmen
		...
		Schueler s1 = new Schueler(AHETS2,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
		...
		Schueler s4 = new Schueler(AHETS5,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
		Schueler s5 = new Schueler(AHELS2,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
		Schueler s6 = new Schueler(AHELS3,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
		Schueler s7 = new Schueler(AHELS4,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
		Schueler s8 = new Schueler(AHELS5,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
		Schueler s9 = new Schueler(AHMBA2,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
		Schueler s10 = new Schueler(AHMBA3,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
		Schueler s11 = new Schueler(AHMBA4,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
		Schueler s12 = new Schueler(AHMBA5,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
		...
		Schueler t_kat = new Schueler(AHETS2,0123L,"Ibraham","Stevic",test,"ibra@stec.sb",new Adresse("St.Pï¿½lten","Wald",44,3100),test,false);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Folgender Abteil: Anzeigen aller zu Klassen zugehï¿½rigen Elemente nach Auswahl///////////////////////////////////////////////
...
// Folgender Abteil: Erzeugen von neuen Klassen ///////////////////////////////////////////////////////////////////////////////
				...
				case ER:
					...
					try
					{
						System.out.println("Folgend wird abgefragt: Nummer,Sitzplï¿½tze,Raumtyp(1..4)");
